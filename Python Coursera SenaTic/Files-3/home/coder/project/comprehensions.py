...
def generate_usernames(mod_list):
   ...
   #for user_name_list in mod_list:
      #user_name_list.replace(" ", "_")
      
   #return user_name_list
   
   return [user_name_list.replace(" ", "_") for user_name_list in mod_list]
...
def map_id_to_initial(employee_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
   return {employee_dict['name'][0]: employee_dict['id'] for employee_dict in employee_list}
